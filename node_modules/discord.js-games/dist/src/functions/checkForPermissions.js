...
function checkForPermissions(message, tag, avatar) {
    ...
    if (channel instanceof discord_js_1.TextChannel ||
        ...
        if (!perms?.has('ADD_REACTIONS')) {
            const embed = new discord_js_1.MessageEmbed()
                ...
                .setDescription(`❌ I am missing the ${(0, builders_1.inlineCode)('Add Reactions')} permission, please give it to me before using this command`)
                .setTimestamp();
